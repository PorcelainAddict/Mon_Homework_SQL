...
-- Returns all the names of folk in the DB.

-- UPDATE people SET name = 'Krusty the Clown' WHERE name = 'Crusty the Clown';
-- SELECT name FROM people;
-- Crusty has been changed to Krusty;

-- SELECT name FROM people WHERE name = 'Homer Simpson';
--Only returns HOMER SIMPSON (1 ROW)

-- DELETE FROM movies WHERE title = 'Batman Begins';
-- SELECT * FROM movies
-- DELETES Batman Begins from table (including year and show time)

-- INSERT INTO people (name) VALUES ('Bart Simpson');
-- SELECT name FROM people
-- Inserts Bart Simpson into the table.

-- DELETE FROM people WHERE name = 'Eric Cartman';
-- SELECT name FROM people
-- punts Eric Cartman from the roster.

-- INSERT INTO movies (title, year, show_time) VALUES ('Avengers: Inifity Fight - Midnight Special', 2019, '00:00');
-- SELECT * FROM movies
-- pops in the midnight special viewing of The Avengers.

-- UPDATE movies SET show_time = '20:45' WHERE title = 'Iron Man 3';
-- SELECT * FROM movies
-- Sets the new time as 20:45.
